...
import com.example.tabish.belief.cameraback.HiddenCamera.config.CameraRotation;
...
public final class HiddenCameraUtils {
    ...
    @SuppressWarnings("deprecation")
    public static boolean isRearCameraAvailable(@NonNull Context context){
        int numCameras = Camera.getNumberOfCameras();
        return numCameras > 0 && context.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA);
    }
